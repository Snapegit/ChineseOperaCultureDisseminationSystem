				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="毕业院校" prop="biyeyuanxiao">
							<el-input class="list_inp" v-model="form.biyeyuanxiao" placeholder="毕业院校"
								 type="text" 								:readonly="!isAdd||disabledForm.biyeyuanxiao?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="戏曲成就" prop="xiquchengjiu">
							<el-input class="list_inp" v-model="form.xiquchengjiu" placeholder="戏曲成就"
								 type="text" 								:readonly="!isAdd||disabledForm.xiquchengjiu?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="戏曲作品" prop="xiquzuopin">
							<el-input class="list_inp" v-model="form.xiquzuopin" placeholder="戏曲作品"
								 type="text" 								:readonly="!isAdd||disabledForm.xiquzuopin?true:false" />
						</el-form-item>
					</el-col>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.gerenjianjie = res.data.data.gerenjianjie?(res.data.data.gerenjianjie.replace(reg,'../../../cl0128880/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='biyeyuanxiao'){
					form.value.biyeyuanxiao = row[x];
					disabledForm.value.biyeyuanxiao = true;
					continue;
				}
				if(x=='xiquchengjiu'){
					form.value.xiquchengjiu = row[x];
					disabledForm.value.xiquchengjiu = true;
					continue;
				}
				if(x=='xiquzuopin'){
					form.value.xiquzuopin = row[x];
					disabledForm.value.xiquzuopin = true;
					continue;
				}
				if(x=='gerenjianjie'){
