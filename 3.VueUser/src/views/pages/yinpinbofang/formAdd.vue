	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"0px","background":"#fff","width":"86%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="8">
					<el-form-item label="发展历史" prop="fazhanlishi">
						<el-input class="list_inp" v-model="form.fazhanlishi" placeholder="发展历史"
							 type="text" 							:readonly="!isAdd||disabledForm.fazhanlishi?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="8">
					<el-form-item label="戏曲流派" prop="xiquliupai">
						<el-input class="list_inp" v-model="form.xiquliupai" placeholder="戏曲流派"
							 type="text" 							:readonly="!isAdd||disabledForm.xiquliupai?true:false" />
					</el-form-item>
				</el-col>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='fazhanlishi'){
					form.value.fazhanlishi = row[x];
					disabledForm.value.fazhanlishi = true;
					continue;
				}
				if(x=='xiquliupai'){
					form.value.xiquliupai = row[x];
					disabledForm.value.xiquliupai = true;
					continue;
				}
				if(x=='yinpin'){
