	...
	<div class="app-contain" :style='{"padding":"0px 0","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"86%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">戏曲分类</div>
					<div  class="info_text" >{{detail.xiqufenlei}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">艺术家</div>
					<div  class="info_text" >{{detail.yishujia}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">发展历史</div>
					<div  class="info_text" >{{detail.fazhanlishi}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">戏曲流派</div>
					<div  class="info_text" >{{detail.xiquliupai}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('shipinbofang','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('shipinbofang','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
...
<script setup>
	...
	const getDetail = () => {
		context?.$http({
			...
			title.value = res.data.data.xiqumingcheng
